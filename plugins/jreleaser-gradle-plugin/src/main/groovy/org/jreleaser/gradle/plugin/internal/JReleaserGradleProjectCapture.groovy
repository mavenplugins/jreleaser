...
class JReleaserGradleProjectCapture implements Serializable {
    ...
    private final String javaApplicationMainClass
    private final String javaApplicationMainModule
    ...
    String getJavaApplicationMainClass() {

        return javaApplicationMainClass
    }

    String getJavaApplicationMainModule() {
        return javaApplicationMainModule
    }
